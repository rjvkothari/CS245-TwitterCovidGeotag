...
def parse_args(argv):
    ...
    parser.add_argument('-state_present', '--state_present', metavar='bool', help='whether state present in data', type=bool,
                        default=False)
    parser.add_argument('-ckpt_dir', '--ckpt_dir', metavar=str, help='checkpoint directory', type=str, default='./ckpt_dir/')
    parser.add_argument('-eval_mode', '--eval_mode', metavar='bool', help='only evaluation to be done?', type=bool,
                        default=False)
    parser.add_argument('-eval_data', '--eval_data', metavar=str, help='evaluation data file', type=str, default='')
